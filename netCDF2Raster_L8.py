...
arcpy.env.workspace = "Z:/LaRC_ChesapeakeBayWaterResourcesII/Data/Landsat8_AllScenes/P15R33" # change to the path where all files with .nc files are 
overwriteOutput = True

#Make NetCDF Raster Layer Input Variables
variableList = ["RRS_443", "RRS_483", "RRS_561", "RRS_655", "RRS_865", "RRS_1609", "RRS_2201", "T_DOGLIOTTI", "T_DOGLIOTTI_RED", "T_DOGLIOTTI_NIR", "T_GARABA_645_LIN", "T_NECHAD_645"]
XDimension = "x" 
YDimension = "y" 
bandDimmension = ""
dimensionValues = ""
